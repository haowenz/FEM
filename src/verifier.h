...
void genOneResult(const int refIndex,const Read *read, const int rc, const int secondary, const int location, const char* cigar, const int err,const char* MD, uint32_t *resulStrtLen, char** resultStr);
